...
namespace BookBazaar.Data.Migrations
{
    ...
    [Migration("20231105204951_ModifiedCategoryTable")]
            ...
            modelBuilder.Entity("BookBazaar.Models.InventoryModels.InventoryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            DateAdded = new DateTime(2023, 11, 5, 22, 49, 51, 147, DateTimeKind.Local).AddTicks(224),
                            QuantityInStock = 40,
                            QuantitySold = 0
                        },
                        new
                        {
                            Id = 2,
                            BookId = 2,
                            DateAdded = new DateTime(2023, 11, 5, 22, 49, 51, 147, DateTimeKind.Local).AddTicks(264),
                            QuantityInStock = 60,
                            QuantitySold = 0
                        },
                        new
                        {
                            Id = 3,
                            BookId = 3,
                            DateAdded = new DateTime(2023, 11, 5, 22, 49, 51, 147, DateTimeKind.Local).AddTicks(266),
                            QuantityInStock = 20,
                            QuantitySold = 0
                        });
                });
