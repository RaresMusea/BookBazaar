...
namespace BookBazaar.Data.Migrations
{
    ...
    [Migration("20231029214434_ExpandIdentityFrameworkDefaultUser")]
    partial class ExpandIdentityFrameworkDefaultUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookBazaar.Models.InventoryModels.InventoryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            DateAdded = new DateTime(2023, 10, 29, 23, 44, 34, 417, DateTimeKind.Local).AddTicks(3356),
                            QuantityInStock = 40,
                            QuantitySold = 0
                        },
                        new
                        {
                            Id = 2,
                            BookId = 2,
                            DateAdded = new DateTime(2023, 10, 29, 23, 44, 34, 417, DateTimeKind.Local).AddTicks(3401),
                            QuantityInStock = 60,
                            QuantitySold = 0
                        },
                        new
                        {
                            Id = 3,
                            BookId = 3,
                            DateAdded = new DateTime(2023, 10, 29, 23, 44, 34, 417, DateTimeKind.Local).AddTicks(3404),
                            QuantityInStock = 20,
                            QuantitySold = 0
                        });
                });
