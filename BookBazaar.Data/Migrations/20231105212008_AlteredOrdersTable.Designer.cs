...
namespace BookBazaar.Data.Migrations
{
    ...
    [Migration("20231105212008_AlteredOrdersTable")]
    partial class AlteredOrdersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookBazaar.Models.InventoryModels.InventoryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 1,
                            DateAdded = new DateTime(2023, 11, 5, 23, 20, 8, 562, DateTimeKind.Local).AddTicks(4479),
                            QuantityInStock = 40,
                            QuantitySold = 0
                        },
                        new
                        {
                            Id = 2,
                            BookId = 2,
                            DateAdded = new DateTime(2023, 11, 5, 23, 20, 8, 562, DateTimeKind.Local).AddTicks(4527),
                            QuantityInStock = 60,
                            QuantitySold = 0
                        },
                        new
                        {
                            Id = 3,
                            BookId = 3,
                            DateAdded = new DateTime(2023, 11, 5, 23, 20, 8, 562, DateTimeKind.Local).AddTicks(4529),
                            QuantityInStock = 20,
                            QuantitySold = 0
                        });
                });
